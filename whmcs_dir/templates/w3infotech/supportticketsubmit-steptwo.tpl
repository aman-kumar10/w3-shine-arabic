<div class="customsupportticket">
    <h2>{$LANG.supportTicketHeading}</h2>
    ...
    <div class="card">
        <div class="card-body extra-padding">
            ...
            <div class="form-group customAttachment">
            ...
            <p class="text-center supportticketsumbit-btn">
                ...
                <a href="supporttickets.php" class="btn btn-primary">{lang key='cancel'}</a>
            </p>
