...
<div class="custom-contact_page">
    <div class="container">
        <div class="account_manage-info">
            <div class="alert alert-block alert-info">
                <form role="form" method="post" action="{routePath('account-contacts')}">
                    <div class="row">
                        <label for="inputContactId" class="col-lg-3 col-form-label">{lang key='clientareachoosecontact'}</label>
                        <div class="col-lg-7">
