...
<div class="custom-user-management">
    <div class="container">
        <div class="card">
            <div class="card-body">
                ...
                <table class="table table-striped">
                    <tr>
                        ...
                        <th width="300" class="account-user-td">{lang key="userManagement.actions"}</th>
                    </tr>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="post" action="{routePath('account-users-invite')}">
                    ...
                    <div class="form-group invite-Group-Permiss">
            ...
            <div class="modal fade" id="modalCancelInvite">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default close-popup" data-dismiss="modal">
                                {lang key="cancel"}
                            </button>
