<div class="container custom-domain-details">
    ...
    <div class="sidebar">
        ...
        <!-- {include file="$template/includes/domain_navbar.tpl" sidebar=$secondarySidebar} -->
    </div>
    ...
    <div class="tab-content margin-bottom">
                ...
                <div class="card-body">
                    ...
                    {if $sslStatus}
                        <div class="row mb-3">
                            ...
                            {/if}
                            {if $registrar_agreement}
                                <div class="col-lg-6 domain-register-agree">
                                    <h5>Registrar Agreement</h5>
                                    <a href="{$WEB_ROOT}/modules/addons/verify_domain_identity/uploadfile/registrant_agreements/{$registrar_agreement->document}" download>
                    ...
                    {if $addons.idprotection}
                        <div class="row mb-3">
                            ...
                            <div class="col-9 col-md-10">
                                ...
                                <p class="doamin-content_addon-txt">{lang key='domainaddonsidprotectioninfo'}</p>
                                <form action="clientarea.php?action=domainaddons" method="post" class="email-fwd">
                                    <input type="hidden" name="id" value="{$domainid}"/>
                    ...
                    {if $addons.dnsmanagement}
                        ...
                        <div class="row margin-bottom">
                            ...
                            <div class="col-9 col-md-10">
                                ...
                                <p class="doamin-content_addon-txt">{lang key='domainaddonsdnsmanagementinfo'}</p>
                                <form action="clientarea.php?action=domainaddons" method="post"  class="email-fwd">
                                    <input type="hidden" name="id" value="{$domainid}"/>
                    ...
                    {if $addons.emailforwarding}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-9 col-md-10">
                                ...
                                <p class="doamin-content_addon-txt">{lang key='domainaddonsemailforwardinginfo'}</p>
                                <form action="clientarea.php?action=domainaddons" method="post"  class="email-fwd">
                                    <input type="hidden" name="id" value="{$domainid}"/>
        ...
        <div class="tab-pane fade" id="tabMyDocuments">
                ...
                <div class="card-body">
                    <div class="add_documents">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="uplaod_my_documents" value="true"/>
                            <input type="hidden" name="domain_id" value="{$domainid}"/>
                            <div class="row">

                                <div class="form-group col-md-4">
                                    <label for="company_documents">Document Type</label>
                                    <select class="domain_select select_domain_doc form-control" id="company_documents" name="company_document">
                                    ...
                                    <input type="text" class="domain_select select_domain_val form-control d-none" name="company_document_other" placeholder="Enter other document details">
                                </div>
                    ...
                    <div class="view_documents">
                        ...
                        <table id="summaryDomains" class="table table-themed dataTable" style="width: 100%">
                            ...
                            <tbody>
                                {if isset($my_domain_details)}
                                    {foreach $my_domain_details as $domain_item}
                                    
                                        <tr>
                                            <td>Company Document</td>
                                            <td>{$domain_item->company_document}</td>
                                        </tr>
                                        <tr>
                                            <td>Trade Mark</td>
                                            <td>{$domain_item->trade_mark}</td>
                                        </tr>
                                        <tr>
                                            <td>Expiry Date</td>
                                            <td>{$domain_item->expirey_date}</td>
                                        </tr>
                                        <tr>
                                            <td>Company Name</td>
                                            <td>{$domain_item->company_name}</td>
                                        </tr>
                    
                                        {if isset($domain_item->files)}
                                            {foreach $domain_item->files as $domain_file}
                                                <tr>
                                                    <td style="text-transform: capitalize;">{$domain_file.type}</td>
                                                    <td><a class='' href='/modules/addons/verify_domain_identity/uploadfile/{$domain_file.full_name}' download>
                                                        <span style="text-transform: capitalize;">{$domain_file.type} <i class="fas fa-download"></i></span></a>
                                                    </td>
                                                </tr>
                                            {/foreach}
                                        {/if}
...
<script>
    $(document).ready(function () {
        ...
        if (hash === "#tabMyDocuments") {
            $('.tab-pane').removeClass('active');
            $('#tabMyDocuments').addClass('active');
        }
    });
</script>