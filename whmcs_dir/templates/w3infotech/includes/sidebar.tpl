        ...
        <div class="collapsable-card-body">
            ...
            {if $item->hasChildren()}
                <div class="list-group list-group-flush d-md-flex{if $item->getChildrenAttribute('class')} {$item->getChildrenAttribute('class')}{/if}" role="tablist">
                    ...
                    {/foreach}
<!-- 
                    {if $templatefile == 'clientareadomaindetails'}
                        <a menuitemname="My Documents" href="#tabMyDocuments" class="list-group-item list-group-item-action" data-toggle="list" role="tab" id="Primary_Sidebar-Domain_Details_Management-My_Documents" aria-selected="false">
                            <div class="sidebar-menu-item-wrapper">
                                <div class="sidebar-menu-item-label">
                                    My Documents
                                </div>
