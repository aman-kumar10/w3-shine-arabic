            ...
            {if $update eq "nameservers"}
                ...
                {for $num=1 to 5}
                    <div class="form-group row">
                        <label for="inputNs{$num}" class="col-sm-3 col-form-label">{lang key='clientareanameserver'} {$num}</label>
                        <div class="col-sm-9">
                ...
                <div class="row">
                    <div class="col-sm-8 offset-sm-4">
                        <button type="submit" class="btn btn-primary btn-lg btn-changename">
...
<a href="clientarea.php?action=domains" class="btn btn-default mb-3">
