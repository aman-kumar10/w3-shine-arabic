...
<div class="custom-two-factor-auth">
    <div class="container">
        ...
        {if $twoFactorAuthAvailable}
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{routePath('account-security-two-factor-enable')}" class="btn open-modal twofa-config-link enable{if $twoFactorAuthEnabled} w-hidden{/if}" data-modal-title="{lang key='twofaenable'}" data-modal-class="twofa-setup" data-btn-submit-id="btnEnable2FA">
